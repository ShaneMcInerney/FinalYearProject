...
namespace FYP_Droid.Widgets
{
    ...
    public class SleepTrackerWidget : AppWidgetProvider
    {
        ...
        {
            var intent = new Intent(context, typeof(SleepTrackerService));
        ...
        public override void OnReceive(Context context, Intent intent)
        {
            ...
            {
                if (SleepTrackerService.IsRunning == false)
                {
                    context.StartService(new Intent(context, typeof(SleepTrackerService)));
                }
            }
            if (intent.HasExtra("STOP"))
            {
                if (SleepTrackerService.IsRunning)

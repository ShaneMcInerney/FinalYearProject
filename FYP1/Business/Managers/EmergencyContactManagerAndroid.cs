...
{
    public class EmergencyContactManagerAndroid : IEmergencyContactManager
    {
        #region Fields
        ...
        /// Default Constructor
        /// </summary>
        public EmergencyContactManagerAndroid()
        {
        ...
        public EmergencyContactManagerAndroid(AppDatabase database)
        {
